...
<span style="background-color:#F7DF1E;color:#000000;border-radius:3px;padding:2px 5px;">#javascript</span>
<span style="background-color:#3d8836;color:#ffffff;border-radius:3px;padding:2px 5px;">#node</span>
...
<span style="background-color:#A9022A;color:#FFFFFF;border-radius:3px;padding:2px 5px;">#angular</span>
<span style="background-color:#41B883;color:#35495E;border-radius:3px;padding:2px 5px;">#vue</span>
<span style="background-color:#222222;color:#61DAF6;border-radius:3px;padding:2px 5px;">#react</span>
<span style="background-color:#bf4080;color:#FFFFFF;border-radius:3px;padding:2px 5px;">#sass</span>
<span style="background-color:#c73307;color:#FFFFFF;border-radius:3px;padding:2px 5px;">#postcss</span>
<span style="background-color:#533B78;color:#FFFFFF;border-radius:3px;padding:2px 5px;">#bootstrap</span>
<span style="background-color:#533B78;color:#FFFFFF;border-radius:3px;padding:2px 5px;">#bootstrap</span>
<span style="background-color:#14B4C6;color:#FFFFFF;border-radius:3px;padding:2px 5px;">#tailwind</span>
